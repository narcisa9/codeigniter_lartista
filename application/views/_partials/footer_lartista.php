 ...
 <?php $d="block" ?>
 <div class="w3-row">
<div class="w3-card-4" style="display:<?php echo $d ?>">
<header class="w3-container w3-yellow  w3-hover-orange">
  <div class="w3-xlarge w3-yellow  w3-hover-orange w3-allerta">
  <span style="padding-right:10px; font-size:1em"><span class="w3-badge w3-red">15 lei</span></span>Astăzi la meniul zilei avem: 
  </div>
</header>
<div class="w3-container" style="background-color:black;opacity: 0.7; color:white;
    filter: alpha(opacity=70);">
  <p style="opacity: 1; color:white;
    filter: alpha(opacity=100); font-weight:1; font-size:1.1em;padding-top:10px">
	 1. Ciorbă de pui;<br>
...
<footer class="w3-container w3-cyan w3-allerta">
  <h4 class="w3-allerta">Comenzi la domiciliu: 0350 808 780; 0749 058 659</h4>
            ...
            <div class="footer-content">
                @ 2017 L'Artista. Made by <a href="#" title="Narcisa HTML Themes">Narcisa</a> &amp; <a href="https://HTML.org/" title="HTML Themes">HTML</a>. </div>
        </div>
    </div>
...
<script type='text/javascript' src='<?php echo base_url("assets/js/jquery/jquery.js"); ?>'></script>
    ...
    <script type='text/javascript' src='<?php echo base_url("assets/rs-slider/js/jquery.themepunch.tools.min.js"); ?>'></script>
    <script type='text/javascript' src='<?php echo base_url("assets/rs-slider/js/jquery.themepunch.revolution.min.js"); ?>'></script>
    ...
    <script type='text/javascript' src='<?php echo base_url("assets/js/jquery.animsition.min.js"); ?>'></script>
    <script type='text/javascript' src='<?php echo base_url("assets/js/superfish.js"); ?>'></script>
    <script type='text/javascript' src='<?php echo base_url("assets/js/waypoints.min.js"); ?>'></script>
    <script type='text/javascript' src='<?php echo base_url("assets/js/jquery.mobilemenu.js"); ?>'></script>
